...
const UUID = process.env.UUID || 'cdf86828-92e6-45d6-a872-c1664377d7f1'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'clean-nydia-cooku-39df8c99.koyeb.app';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
